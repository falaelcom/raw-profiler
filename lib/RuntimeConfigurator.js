...
class RuntimeConfigurator extends EventEmitter
{
	...
	//	{
	//		{ setting: "runtimeConfigurator.commandFilePath", type: "preconf", value: "__pfenabled.custom" },
	//		{ setting: "runtimeConfigurator.configurationFilePath", type: "preconf", value: "__pfconfig.custom" },
	...
	getConfigurationLines(prefix = null)
	{
		...
		result.push({ setting: fp + "commandFilePath", type: "preconf", value: this.commandFilePath });
		result.push({ setting: fp + "configurationFilePath", type: "preconf", value: this.configurationFilePath });
