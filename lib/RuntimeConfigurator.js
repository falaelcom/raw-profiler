...
class RuntimeConfigurator extends AsyncEventEmitter
{
	...
	set commandFilePath(value)
	{
		...
		this.onChanged("commandFilePath", value, oldValue, "prop");
	}
	...
	set configurationFilePath(value)
	{
		...
		this.onChanged("configurationFilePath", value, oldValue, "prop");
	}
	...
	set refreshSilenceTimeoutMs(value)
	{
		...
		this.onChanged("refreshSilenceTimeoutMs", value, oldValue, "prop");
	}
